...
float fp24_8_as_float (fp24_8 v) { return float( outer_as_uint(v) ) + inner_as_float(v); }

vec2  uvec2_fp24_8_as_vec2 (uvec2_fp24_8 v) { return vec2 (outer_as_uvec2(v)) + inner_as_vec2(v); }
uvec2 uvec2_fp24_8_as_uvec2(uvec2_fp24_8 v) { return uvec2(v.x.value, v.y.value); }
...
fp24_8 mul(fp24_8 x, fp22_10 y) { return fp24_8((x.value * y.value) >> 10u); }

fp24_8 add(fp24_8 x, fp24_8 y)  { return fp24_8(x.value + y.value); }
fp24_8 sub(fp24_8 x, fp24_8 y)  { return fp24_8(x.value - y.value); }

fp24_8  fp24_8_from_float (float v) { return fp24_8(uint(v * float(1u << 8u))); }//return fp24_8 ((uint(v) << 8u ) + uint(fract(v) * float(1u << 8u ))); }
fp22_10 fp22_10_from_float(float v) { return fp22_10(uint(v * float(1u << 10u))); }//return fp22_10((uint(v) << 10u) + uint(fract(v) * float(1u << 10u))); }
...
uvec2_fp24_8  uvec2_fp24_8_from_uvec2 (uvec2 v) { return uvec2_fp24_8 (fp24_8 (v.x), fp24_8 (v.y)); }
uvec2_fp22_10 uvec2_fp22_10_from_uvec2(uvec2 v) { return uvec2_fp22_10(fp22_10(v.x), fp22_10(v.y)); }
...
uvec2_fp24_8 add(uvec2_fp24_8 x, uvec2 y) { return add( x, uvec2_fp24_8_from_uvec2(y) ); }
...
uvec2_fp24_8 add(uvec2_fp24_8 x, vec2 y) { return add(x, ivec2(y * float(1u << 8u))); }
