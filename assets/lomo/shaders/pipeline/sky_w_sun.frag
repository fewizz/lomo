...
void main() {
	...
	face[0] = sky(rotation( PI / 2.0, y_axis) * d, 1.0);
	face[1] = sky(rotation(-PI / 2.0, y_axis) * d, 1.0);
	face[2] = sky(rotation(-PI / 2.0, x_axis) * d, 1.0);
	face[3] = sky(rotation( PI / 2.0, x_axis) * d, 1.0);
	face[4] = sky(                              d, 1.0);
	face[5] = sky(rotation( PI,       y_axis) * d, 1.0);
}